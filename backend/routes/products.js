...
router.get('/', (req, res, next) => {
  ...
  // }
  MongoClient.connect(
    "mongodb+srv://siswa_mdb:P0rP8iSq2ecLM906@cluster0.bdxkx.mongodb.net/shop?retryWrites=true&w=majority"
  )
    .then((client) => {
      const products = [];
      client
...
router.post('', (req, res, next) => {
  const newProduct = {
    ...
    price: Decima128.fromString(req.body.price.toString()), // store this as 128bit decimal in MongoDB
